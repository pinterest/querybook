...
class TestVerifyEveryEnvironmentPermission:
    ...
    def setup_mocks(self, monkeypatch, fake_user, fake_verify_api_access_token_environment_permission):
        monkeypatch.setattr(permission, "current_user", fake_user)
        monkeypatch.setattr(permission, "verify_api_access_token_environment_permission", fake_verify_api_access_token_environment_permission)
