export const faqs = [
    ...
    <ul>
        ...
        <li>
            <u className="mr4">
                <i className="mr8">Error from DataHub worker</i>
            </u>
            is the default error message. It is likely to be
            caused by misconfiguration of DataHub or an internal
            bug. Please check with the maintainer of DataHub to
    ...
    [
        ...
        <ul>
            ...
            <li>
                Notifications with the message "Insert cell
        ...
        <p>
            ...
            maintainer of DataHub to investigate the cause
    ...
    [
        ...
        DataHub’s templating uses Jinja2 syntax and
    ...
    [
        ...
        `<p>
            Please report bugs <i><a href="https://github.com/pinterest/datahub/issues">here</></i>
        </p>`,
    ],
    [
        'How do I make a feature request?',
        `<p>
            Please make feature requests <i><a href="https://github.com/pinterest/datahub/issues">here</a></i>
        </p>`,
    ],
    [
        'Where can I see all the planned features for DataHub?',
        `<p>
            You can view our roadmap and feature development process <i><a href="https://github.com/pinterest/datahub/projects">here</a></i>
        </p>`,
    ],
];
