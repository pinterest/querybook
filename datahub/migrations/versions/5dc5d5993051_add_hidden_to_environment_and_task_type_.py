...
def upgrade():
    ...
    op.create_foreign_key('task_run_record_task_schedule_fk', 'task_run_record',
                          'task_schedule', ['name'], ['name'], ondelete='CASCADE')
    op.add_column('task_schedule', sa.Column('task_type', sa.String(length=255), nullable=False, server_default='prod'))
...
def downgrade():
    ...
    op.drop_constraint('task_run_record_task_schedule_fk', 'task_run_record', type_='foreignkey')
