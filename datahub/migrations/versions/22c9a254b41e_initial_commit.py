...
def upgrade():
    ...
    sa.Column('cell_type', sa.Enum('query', 'text', 'chart', name='datacelltype'), nullable=False),
    sa.Column('context', sa.Text(length=16777215), nullable=True),
    sa.Column('meta', sa.String(length=5000), nullable=True),
    ...
    op.create_table('data_job_metadata',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('job_name', sa.String(length=191), nullable=True),
    sa.Column('job_info', sa.String(length=5000), nullable=True),
    ...
    op.create_index(op.f('ix_data_job_metadata_job_name'), 'data_job_metadata', ['job_name'], unique=False)
    ...
    op.create_table('function_documentation',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('query_metastore',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('metastore_url', sa.Text(length=16777215), nullable=True),
    ...
    sa.Column('args', sa.Text(length=16777215), nullable=True),
    sa.Column('kwargs', sa.Text(length=16777215), nullable=True),
    sa.Column('options', sa.Text(length=16777215), nullable=True),
    ...
    op.create_table('api_access_token',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('meta', sa.Text(length=16777215), nullable=False),
    ...
    sa.Column('item_type', sa.Enum('DATA_DOC', 'DATA_TABLE', name='itemtype'), nullable=True),
    sa.Column('uid', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['uid'], ['user.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('query_engine',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('name', sa.String(length=255), nullable=False),
    ...
    sa.Column('executor_params', sa.Text(length=16777215), nullable=True),
    sa.Column('control_params', sa.Text(length=16777215), nullable=False),
    sa.Column('metastore_id', sa.Integer(), nullable=True),
    sa.Column('environment_id', sa.Integer(), nullable=False),
    sa.Column('archived', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['environment_id'], ['environment.id'], ondelete='CASCADE'),
    ...
    op.create_table('data_doc_data_cell',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table('data_doc_editor',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table('favorite_data_doc',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('data_doc_id', sa.Integer(), nullable=True),
    sa.Column('uid', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['data_doc_id'], ['data_doc.id'], ),
    ...
    sa.Column('status', sa.Enum('INITIALIZED', 'DELIVERED', 'RUNNING', 'DONE', 'ERROR', 'CANCEL', name='queryexecutionstatus'), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    ...
    op.create_table('data_cell_query_execution',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f('ix_data_table_column_name'), 'data_table_column', ['name'], unique=False)
    op.create_table('data_table_information',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('description', sa.Text(length=16777215), nullable=True),
    sa.Column('hive_metastore_description', sa.Text(length=16777215), nullable=True),
    sa.ForeignKeyConstraint(['data_table_id'], ['data_table.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    mysql_charset='utf8mb4',
    mysql_engine='InnoDB'
    )
    op.create_table('data_table_ownership',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('data_table_id', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('owner', sa.String(length=255), nullable=True),
    ...
    op.create_table('query_execution_error',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('query_execution_notification',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('query_execution_id', sa.Integer(), nullable=True),
    ...
    op.create_table('statement_execution',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('statement_range_start', sa.Integer(), nullable=False),
    sa.Column('statement_range_end', sa.Integer(), nullable=False),
    sa.Column('query_execution_id', sa.Integer(), nullable=True),
    sa.Column('status', sa.Enum('INITIALIZED', 'RUNNING', 'UPLOADING', 'DONE', 'ERROR', 'CANCEL', name='statementexecutionstatus'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['parent_table_id'], ['data_table.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['table_id'], ['data_table.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('statement_execution_stream_log',
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.Column('statement_execution_id', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('log', sa.String(length=5000), nullable=True),
    sa.ForeignKeyConstraint(['statement_execution_id'], ['statement_execution.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
