...
def upgrade():
    ...
    op.create_index(op.f('ix_admin_audit_log_item_id'), 'admin_audit_log', ['item_id'], unique=False)
    op.create_index(op.f('ix_admin_audit_log_item_type'), 'admin_audit_log', ['item_type'], unique=False)
    op.create_index(op.f('ix_impression_item_id'), 'impression', ['item_id'], unique=False)
    op.create_index(op.f('ix_impression_item_type'), 'impression', ['item_type'], unique=False)
