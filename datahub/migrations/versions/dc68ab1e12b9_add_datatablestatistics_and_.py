...
def upgrade():
    ...
    op.create_table('data_table_statistics',
    ...
    op.create_index(op.f('ix_data_table_statistics_key'),
                    'data_table_statistics', ['key'], unique=False)

    op.create_table('data_table_column_statistics',
                    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_data_table_column_statistics_key'),
                  table_name='data_table_column_statistics')
    op.drop_table('data_table_column_statistics')
    op.drop_index(op.f('ix_data_table_statistics_key'),
                  table_name='data_table_statistics')
